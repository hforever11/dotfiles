...
> 設定ファイル: `dot_config/nvim/lua/config/exact_plugins/csvview.lua`。Neovim 0.10+ が必要。
...
> 設定ファイル: `dot_config/nvim/lua/config/exact_plugins/render-markdown.lua` / `arto.lua`。
